                ...
                {filteredCategories.map((category, index) => (
                  ...
                  >
                    <div className="flex items-center justify-between gap-3 md:block">
                      ...
                      <span className="rounded-[6px] bg-muted px-2 py-0.5 text-[10.5px] font-bold text-muted-foreground md:hidden">
                        Cadastrada
                      </span>
                    </div>
                    ...
                    <div className="hidden md:block">
                      <span className="inline-flex rounded-[6px] bg-muted px-2 py-0.5 text-[10.5px] font-bold text-muted-foreground">
                        Cadastrada
                      </span>
                    </div>
                    ...
                    <div className="flex justify-end gap-1.5">
                      <Button
                        ...
                        className="h-7 w-7 cursor-pointer rounded-[7px] bg-muted text-foreground hover:bg-muted"
            ...
            <div className="mt-3 rounded-[8px] border border-border bg-muted p-3">
              {previewCategories.length === 0 ? (
                ...
                <div className="flex flex-wrap gap-1.5">
                  <span className="rounded-full bg-zinc-900 px-3 py-1.5 text-[11.5px] font-bold text-white">
                    Todos
                  </span>
                  {previewCategories.map((category) => (
                    <span
                      key={category.id}
                      className="rounded-full border border-border bg-card px-3 py-1.5 text-[11.5px] font-semibold text-foreground"
                    >
                      {category.name}
                    </span>
                  ))}
